...
export default defineConfig({
  ...
  resolve: {
    alias: {
      ...
      "@mahiva/imports": path.resolve(__dirname, "packages/imports/src/index.ts"),
      "@mahiva/analyzer": path.resolve(__dirname, "packages/analyzer/src/index.ts"),
      "@mahiva/relationships": path.resolve(__dirname, "packages/relationships/src/index.ts"),
      "@mahiva/graph": path.resolve(__dirname, "packages/graph/src/index.ts"),
      "@mahiva/database": path.resolve(__dirname, "packages/database/src/index.ts"),
